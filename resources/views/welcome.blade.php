...
<body class="antialiased text-slate-900 overflow-x-hidden">
    ...
    <!-- Hero Section -->
    <section id="home" class="relative min-h-screen flex items-center pt-32 overflow-hidden bg-slate-50">
    ...
    <!-- Stats Bar (Injected Theme Color) -->
    <div class="bg-gradient-premium py-24 relative overflow-hidden">
    ...
    <!-- Services Section -->
    <section id="services" class="relative section-padding bg-white">
        <div class="max-w-7xl mx-auto px-6 lg:px-10">
    ...
    <!-- About Section (Injected Dark/Theme Background) -->
    <section id="about" class="section-padding bg-gradient-dark relative overflow-hidden">
    ...
    <!-- Contact Section -->
    <section id="contact" class="section-padding bg-slate-50 relative overflow-hidden">
